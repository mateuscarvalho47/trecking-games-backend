        ...
        {NAV_ITEMS.map(({ to, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              style={{
                background: active ? 'oklch(0.40 0.10 295 / 0.18)' : 'transparent',
                color: active ? 'oklch(0.92 0.19 295)' : 'oklch(0.72 0.010 280)',
                fontFamily: 'inherit',
              }}
            >
              ...
              {to === '/library' && libraryCount !== undefined && (
                <span
                  ...
                  style={{
                    ...
                    background: active ? 'oklch(0.4 0.1 295 / 0.3)' : 'oklch(0.23 0.010 280)',
                  }}
                >
                  {libraryCount}
                </span>
      ...
      <div className="mt-auto">
        <div className="flex items-center gap-2.5 p-2 rounded-md bg-bg-2 border border-border-soft">
          <div
            ...
            style={{
              width: 28, height: 28,
              background: 'linear-gradient(135deg, oklch(0.5 0.18 295), oklch(0.7 0.18 320))',
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[12px] font-semibold text-text-hi">Minha conta</div>

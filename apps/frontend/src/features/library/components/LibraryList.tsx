          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 min-w-0">
                ...
                <span className="text-[11px] font-mono text-text-lo">{game.userPlatform ?? game.platforms[0] ?? '—'}</span>
              </div>
            ...
            >
              ...
              <div className="text-text-md text-[12px]">{game.userPlatform ?? game.platforms[0] ?? '—'}</div>

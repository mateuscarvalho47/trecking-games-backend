...
const FEATURES = [
  { icon: '📚', label: 'Biblioteca', desc: 'Organize todos seus jogos por status — jogando, zerado, backlog.' },
  { icon: '📊', label: 'Estatísticas', desc: 'Visualize horas jogadas, plataformas e histórico ao longo do tempo.' },
  { icon: '🔍', label: 'Busca rápida', desc: 'Encontre qualquer jogo com Ctrl+K e adicione em segundos.' },
]
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-5 py-16 bg-bg-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, oklch(0.5 0.18 295 / 0.2) 0%, transparent 50%)',
        }}
      />
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl" style={{ animation: 'fadeUp 0.5s ease-out both' }}>
        {/* Logo */}
        <div className="flex items-center gap-3 mb-10">
          <svg width="32" height="32" viewBox="0 0 22 22" fill="none" className="text-accent-bright">
          ...
          <span className="text-[28px] font-bold tracking-[-0.03em] text-text-hi">Ludex</span>
        </div>
        ...
        <p className="text-[17px] text-text-md leading-relaxed mb-10 max-w-lg">
          Rastreie o que está jogando, o que zerou e o backlog que nunca para de crescer. Tudo num lugar só.
        </p>
        ...
        <div className="grid grid-cols-3 gap-4 w-full">
          {FEATURES.map((f) => (
            ...
            >
              ...
              <div className="text-[13.5px] font-semibold text-text-hi mb-1.5">{f.label}</div>
              <div className="text-[12px] text-text-lo leading-relaxed">{f.desc}</div>
            </div>
          ))}
        </div>
